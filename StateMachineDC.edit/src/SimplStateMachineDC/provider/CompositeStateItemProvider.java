...
/**
 * This is the item provider adapter for a {@link SimplStateMachineDC.CompositeState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeStateItemProvider extends StateItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplStateMachineDCPackage.Literals.COMPOSITE_STATE__INITIAL_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplStateMachineDCPackage.Literals.COMPOSITE_STATE__STATES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CompositeState.class)) {
			case SimplStateMachineDCPackage.COMPOSITE_STATE__STATES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplStateMachineDCPackage.Literals.COMPOSITE_STATE__STATES,
